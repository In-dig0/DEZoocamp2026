...
BUCKET_NAME = "datawarehouse-demo-485604-bucket"


# If you authenticated through the GCP SDK you can comment out these two lines
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
CREDENTIALS_FILE = os.path.join(BASE_DIR, "keys", "nodal-nirvana-485604-k6-1b5c8f98c203.json")

#CREDENTIALS_FILE = r".\keys\nodal-nirvana-485604-k6-1b5c8f98c203.json"
